...
//     clase que realiza la conexion a la base de datos.
 ...
 {
  private static final String CONFIGURATION_FILE = "co.edu.udea.drai.ingreso.dao.propiedadesBase";
  private static final String STATEMENTS_FILE = "co.edu.udea.drai.ingreso.dao.statements";
  private static final ResourceBundle propiedades = ResourceBundle.getBundle("co.edu.udea.drai.ingreso.dao.propiedadesBase");
   private static final ResourceBundle statements = ResourceBundle.getBundle("co.edu.udea.drai.ingreso.dao.statements");
